...
for j = plotNum
    ...
    f2 = figure; set( f2, 'Position', [410*cc-100 400 500 340])
    ...
    for k = 1: numel( binList)- 1
        ...
        legtxt = sprintf( '%.1f-%.1f', binList(k), binList(k+1));
...
saveas( figure(1), fullfile(outPath, 'Fig7_subMSD_ori.svg'));

saveas( figure(2), fullfile(outPath, 'Fig7_subMSD_ter.svg'));
